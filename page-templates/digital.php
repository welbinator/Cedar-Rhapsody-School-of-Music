<?php /* Template Name: Digital Page */ ?>
<?php echo get_header(); ?>


<div class="hero digital-hero">
    <div class="container">
        <div class="row">
            <div class="col-12 col-lg-6 align-self-center">

                <?php
                $digitalHeading = get_theme_mod('digital-hero-heading');
                if ($digitalHeading != '') { ?>
                    <?php echo wpautop("<h1 class='display-1'> $digitalHeading </h1>"); ?>
                <?php } ?>


                <?php
                $digitalTagline = get_theme_mod('digital-hero-paragraph');
                if ($digitalTagline != '') { ?>
                    <?php echo wpautop("<p> $digitalTagline </p>"); ?>
                <?php } ?>
            ...
            <div class="col-12 col-lg-6">
                <div class="digital-hero-image-container"><img class="img-fluid digital-hero-image hero-image" src="<?php echo wp_get_attachment_url(get_theme_mod('digital-image')) ?>"></div>
            </div>
        </div>
    </div>
</div>
...
<div class="section">
    <div class="container">
        ...
        <?php
        $digitalSecondHeading = get_theme_mod('second-digital-heading');
        if ($digitalSecondHeading != '') { ?>
            <?php echo wpautop("<h1 class='text-center text-lg-left mb-0 mt-4 mt-lg-0'><strong> $digitalSecondHeading </strong></h1>"); ?>
        <?php } ?>



        <?php
        $digitalSecondTagline = get_theme_mod('second-digital-tagline');
        if ($digitalSecondTagline != '') { ?>
            <?php echo wpautop("<p class='text-center text-lg-left'> $digitalSecondTagline </p>"); ?>
        <?php } ?>
