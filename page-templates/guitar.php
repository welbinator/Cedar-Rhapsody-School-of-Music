<?php /* Template Name: Guitar Page */ ?>
<?php echo get_header(); ?>


<div class="hero guitar-hero">
    <div class="container">
        <div class="row">
            <div class="col-12 col-lg-6 align-self-center">

                <?php
                $guitarHeading = get_theme_mod('guitar-hero-heading');
                if ($guitarHeading != '') { ?>
                    <?php echo wpautop("<h1 class='display-1'> $guitarHeading </h1>"); ?>
                <?php } ?>


                <?php
                $guitarTagline = get_theme_mod('guitar-hero-paragraph');
                if ($guitarTagline != '') { ?>
                    <?php echo wpautop("<p> $guitarTagline </p>"); ?>
                <?php } ?>
            ...
            <div class="col-12 col-lg-6">
                <div class="guitar-hero-image-container"><img class="img-fluid guitar-hero-image hero-image" src="<?php echo wp_get_attachment_url(get_theme_mod('guitar-image')) ?>"></div>
            </div>
        </div>
    </div>
</div>
...
<div class="section">
    <div class="container">
        ...
        <?php
        $guitarSecondHeading = get_theme_mod('second-guitar-heading');
        if ($guitarSecondHeading != '') { ?>
            <?php echo wpautop("<h1 class='text-center text-lg-left mb-0 mt-4 mt-lg-0'><strong> $guitarSecondHeading </strong></h1>"); ?>
        <?php } ?>



        <?php
        $guitarSecondTagline = get_theme_mod('second-guitar-tagline');
        if ($guitarSecondTagline != '') { ?>
            <?php echo wpautop("<p class='text-center text-lg-left'> $guitarSecondTagline </p>"); ?>
        <?php } ?>
